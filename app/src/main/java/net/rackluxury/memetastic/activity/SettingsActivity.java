...
import net.rackluxury.memetastic.service.ThumbnailCleanupTask;
import net.rackluxury.memetastic.util.AppSettings;
import net.rackluxury.memetastic.util.MediaStoreUtils;
import net.rackluxury.memetastic.util.PermissionChecker;
import net.rackluxury.opoc.preference.GsPreferenceFragmentCompat;
import net.rackluxury.opoc.preference.SharedPreferencesPropertyBackend;
